...
import { Paperclip, Send, Settings, StopCircle, RefreshCw, Copy, Download, BrainCircuit, User } from 'lucide-react';
...
export default function AIChat() {
  ...
  return (
    <div className="flex h-[calc(100vh-6rem)] gap-4">
        ...
        <div className="p-4 bg-background border-t border-border">
          <div className="max-w-3xl mx-auto relative flex items-end gap-2 bg-secondary/50 border border-border rounded-xl p-2 focus-within:ring-1 focus-within:ring-primary/50 transition-all">
            ...
            {isGenerating ? (
              ...
              <Button size="icon" className="shrink-0 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground" disabled={!input.trim()}>
      ...
      <Card className="w-64 hidden xl:flex flex-col bg-card border-border overflow-hidden">
